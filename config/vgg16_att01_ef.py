...
experiment_name = "vgg16_att01_ef"

# Model parameters
core_model = "vgg16"  # [vgg16, resnet50, joseph_basic, joseph_extended]
imagenet_weights = True
early_fusion = 256  # [0: None, n: number of FC dimensions]
multi_loss = False
branches = [0, 1]  # [[0], [1], [2], [0, 1], [1, 2], [0, 2], [0, 1, 2]]
